    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td style="width: 257px">
                <asp:TextBox ID="txtFName" runat="server" Width="234px"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td style="width: 257px">
                <asp:TextBox ID="txtLName" runat="server" Width="234px"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:RegularExpressionValidator ID="valEmail" runat="server" ControlToValidate="txtEmail" ErrorMessage="Invalid Email" ForeColor="Red" ValidationExpression="^(?(&quot;)(&quot;.+?(?&lt;!\\)&quot;@)|(([0-9a-z]((\.(?!\.))|[-!#\$%&amp;'\*\+/=\?\^`\{\}\|~\w])*)(?&lt;=[0-9a-z])@))(?(\[)(\[(\d{1,3}\.){3}\d{1,3}\])|(([0-9a-z][-\w]*[0-9a-z]*\.)+[a-z0-9][\-a-z0-9]{0,22}[a-z0-9]))$"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 137px">&nbsp;</td>
        ...
        <tr>
            ...
            <td style="width: 257px">
                <asp:TextBox ID="txtPW" runat="server" TextMode="Password" Width="234px"></asp:TextBox>
            </td>
            <td>
                <asp:RegularExpressionValidator ID="valPW" runat="server" ControlToValidate="txtPW" ErrorMessage="Password must be a minimum of 8 characters long and contain an uppercase letter, a lowercase letter, and a number" ForeColor="Red" ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 257px">
                <asp:TextBox ID="txtPWMatch" runat="server" TextMode="Password" Width="234px"></asp:TextBox>
            </td>
            <td>
                <asp:CompareValidator ID="valPWMatch" runat="server" ControlToCompare="txtPW" ControlToValidate="txtPWMatch" ErrorMessage="Passwords Do Not Match" ForeColor="Red"></asp:CompareValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 137px; margin-left: 40px">&nbsp;</td>
